...
function M.show_message(expected, instead, goToInsert)
  if goToInsert then
...
function M.remove_bicycle_small_whells(opts)
  ...
  set('i', '<Left>', function() M.show_message("H", "Left Arrow", true) end)
  set('i', '<Right>', function() M.show_message("L", "Right Arrow", true) end)
